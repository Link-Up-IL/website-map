...
color_coding <- list(
  ...
  "Extra" = "#0072B2", # an alternative shade of blue that works well (note there is no Extra category for map, just putting the color code here for safe-keeping)
  "Other" = "#E69F00"
)
```
...
# (3) Changing the size of the circle markers for partner locations:
      # Find the second section of code below that starts with addMarkersByType
      # The radius argument controls the size of the circles. Higher numbers = bigger circles.
